...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('settings', function (Blueprint $table) {
            ...
            $table->string('phone_1')->nullable()->comment('Telefone WhatsApp');
            $table->string('phone_2')->nullable()->comment('Telefone ligação');
            ...
            $table->text('whatsapp_default_message')->nullable()->comment('Mensagem padrão do WhatsApp');
