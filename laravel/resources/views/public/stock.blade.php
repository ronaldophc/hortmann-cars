...
@section('content')
    <div class="mx-auto max-w-7xl p-4">
        ...
        <form action="{{ route('stock') }}" method="GET" class="mb-8 flex flex-wrap gap-4 justify-center items-end">
            ...
            <button type="submit" class="w-full md:w-auto btn btn-lg btn-primary">Filtrar</button>
        </form>

        <div class="px-5 pb-24">
            <div class="flex flex-wrap justify-center gap-2">
                @forelse ($vehicles as $vehicle)
                    <a class="card bg-base-200 w-80 shadow-sm mx-auto" href="">
