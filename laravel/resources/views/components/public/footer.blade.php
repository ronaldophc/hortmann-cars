<footer class="footer sm:footer-horizontal bg-base-200 text-base-content p-10 shadow-inner">
    ...
    <nav>
        ...
        <a class="link link-hover text-md">Venda seu carro</a>
        <a class="link link-hover text-md">Sobre nós</a>
        <a class="link link-hover text-md">Contato</a>
    </nav>
    <nav>
        <h6 class="footer-title text-lg">Telefones</h6>
        <a class="link link-hover text-md">(42) 99999-9999</a>
        <a class="link link-hover text-md">(42) 99999-9999</a>
        <h6 class="footer-title mt-2 text-lg">Horários</h6>
        <a class="link link-hover text-md">Segunda a sexta: 08:00 até 18:00</a>
        <a class="link link-hover text-md">Sábado: 08:00 até 12:00</a>
    </nav>
    <nav>
